...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djangocms_accounts_usersettings', (
        ...
        db.send_create_signal('djangocms_accounts', ['UserSettings'])


    def backwards(self, orm):
        # Deleting model 'UserSettings'
        db.delete_table('djangocms_accounts_usersettings')
    ...
    models = {
        ...
        'djangocms_accounts.emailconfirmation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)'}),
        ...
        'djangocms_accounts.usersettings': {
