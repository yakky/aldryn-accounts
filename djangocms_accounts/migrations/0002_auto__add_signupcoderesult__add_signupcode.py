...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djangocms_accounts_signupcoderesult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('signup_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_accounts.SignupCode'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('djangocms_accounts', ['SignupCodeResult'])

        # Adding model 'SignupCode'
        db.create_table('djangocms_accounts_signupcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('djangocms_accounts', ['SignupCode'])


    def backwards(self, orm):
        # Deleting model 'SignupCodeResult'
        db.delete_table('djangocms_accounts_signupcoderesult')

        # Deleting model 'SignupCode'
        db.delete_table('djangocms_accounts_signupcode')
    ...
    models = {
        ...
        'djangocms_accounts.emailconfirmation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 18, 0, 0)'}),
        ...
        'djangocms_accounts.signupcoderesult': {
            'Meta': {'object_name': 'SignupCodeResult'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signup_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djangocms_accounts.SignupCode']"}),
