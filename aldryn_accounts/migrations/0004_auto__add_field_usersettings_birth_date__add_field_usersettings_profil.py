...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.birth_date'
        db.add_column('aldryn_accounts_usersettings', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSettings.profile_image'
        db.add_column('aldryn_accounts_usersettings', 'profile_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.birth_date'
        db.delete_column('aldryn_accounts_usersettings', 'birth_date')

        # Deleting field 'UserSettings.profile_image'
        db.delete_column('aldryn_accounts_usersettings', 'profile_image')
    ...
    models = {
        ...
        'aldryn_accounts.emailconfirmation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 10, 0, 0)'}),
