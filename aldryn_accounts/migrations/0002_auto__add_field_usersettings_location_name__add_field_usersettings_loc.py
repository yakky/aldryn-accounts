...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.location_name'
        db.add_column('aldryn_accounts_usersettings', 'location_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'UserSettings.location_latitude'
        db.add_column('aldryn_accounts_usersettings', 'location_latitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSettings.location_longitude'
        db.add_column('aldryn_accounts_usersettings', 'location_longitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.location_name'
        db.delete_column('aldryn_accounts_usersettings', 'location_name')

        # Deleting field 'UserSettings.location_latitude'
        db.delete_column('aldryn_accounts_usersettings', 'location_latitude')

        # Deleting field 'UserSettings.location_longitude'
        db.delete_column('aldryn_accounts_usersettings', 'location_longitude')
