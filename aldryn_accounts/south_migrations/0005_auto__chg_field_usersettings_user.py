...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('aldryn_accounts_usersettings', 'user_id', self.gf('annoying.fields.AutoOneToOneField')(unique=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'UserSettings.user'
        db.alter_column('aldryn_accounts_usersettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'aldryn_accounts.emailconfirmation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
        ...
        'aldryn_accounts.usersettings': {
            ...
            'user': ('annoying.fields.AutoOneToOneField', [], {'related_name': "'settings'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'auth.group': {
